...
\put(200,50){\circle*{5}}
\put(240,50){\circle*{5}}
\put(300,75){\circle{5} \makebox{Outliers}}
\put(20,40){\line(1,0){230}}
\put(20,40){\line(0,1){20}}
\put(250,40){\line(0,1){20}}
\put(20,60){\line(1,0){230}}
\put(40,40){\dashbox{2}(120,20)[s]{}}
\put(60,10){\shortstack{Quarantined\\Material}}


\end{picture}
\caption[Example 1 of Testing for Outliers]{Example of Testing for Outliers. Two contiguous outliers are found and the material around the outliers is quarantined.}
\end{figure}
